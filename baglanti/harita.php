...
<html>
<head>
<TITLE>TGNTR - Sunucuyu düzenle</TITLE>
<meta charset="utf-8">
...
<div class="container">
	<form action="duzenleislem.php" class="form-signin" method="post">
         <center><h2 class="form-signin-heading">Anlık Sunucu Bilgileri</h2></br>
		 
		 <?php $map = $ts3_VirtualServer->getViewer(new TeamSpeak3_Viewer_Html("baglanti/framework/Viewer/", "images/countryflags/", "data:image")); ?>

		  <?= $map; ?>
					 </br>
				<a class="btn btn-lg btn-primary btn-block" href="yonetimpaneli.php">Geri dön</a>
               </form>
			</div>
</head>
<body>
